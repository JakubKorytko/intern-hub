...
export const deleteUser = async (id: number) => {
  const confirmed = confirm(
    'Czy na pewno chcesz usunac uzytkownika? Operacja ta jest nieodwracalna',
  )
...
export const validateUserData = (
  ...
  if (
    ...
    !urlPattern.test(avatar)
  ) {
    errors.push(
      `Link do zdjecia musi byc poprawny i nie moze przekraczac ${MAX_AVATAR_LENGTH} znakow.`,
    )
  }
